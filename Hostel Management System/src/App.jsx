...
import StudentRoomPage from "./components/dashboard/StudentRoomPage";
import StudentPaymentsPage from "./components/dashboard/StudentPaymentsPage";
import StudentBookRoomPage from "./components/dashboard/StudentBookRoomPage"; // NEW
import UnifiedLogin from "./components/students/UnifiedLogin";
      ...
      <StudentAuthProvider>
        <BrowserRouter>
          <Routes>
            ...
            {/* Student dashboard — Book Room now lives INSIDE here */}
            <Route
              path="/student-dashboard"
              element={
                <StudentDashboardRoute>
            ...
            {/* Staff/Owner dashboard (unchanged) */}
            <Route
              path="/dashboard"
              element={
                <PrivateRoute>
