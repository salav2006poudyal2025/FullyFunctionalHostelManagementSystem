...
const StudentPayment = () => {
  // FIX: removed markPaid — it doesn't exist in StudentAuthContext
  ...
  async function handlePayment(e) {
    ...
    try {
      ...
      setSuccess(true);
      // FIX: navigate to student dashboard book-room page after successful payment
      setTimeout(() => navigate("/student-dashboard/book-room"), 1500);
    } catch (err) {
        ...
        <div className="lp-form-card">
          ...
          {success && (
            <div className="dash-success" style={{ marginBottom: 16 }}>
              ✅ Payment submitted! Redirecting to booking…
            </div>
          )}
          ...
          <form className="lp-form" onSubmit={handlePayment}>
            ...
            <div className="lp-field">
              ...
              <input
                className="lp-input"
                type="text"
                placeholder="e.g. KHL-XXXXXXXXXX"
                value={transactionId}
            ...
            <button type="submit" className="lp-submit-btn" disabled={loading || success}>
